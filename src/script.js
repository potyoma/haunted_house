...
const TEXTURES = ["ambientOcclusion", "color", "normal", "roughness"]
const ADD_TEXTURES = ["alpha", "height", "metalness"]

const loadTextures = (loader, objectName, loadAdditional) =>
  (loadAdditional ? TEXTURES.concat(ADD_TEXTURES) : TEXTURES).reduce(
    (acc, next) => {
...
const [bricksTextures, doorTextures, grassTextures] = [
  "bricks",
  "door",
  "grass",
].map(o => loadTextures(textureLoader, o, o === "door"))
